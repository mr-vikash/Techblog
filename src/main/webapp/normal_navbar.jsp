<nav class="navbar navbar-expand-lg navbar-dark primary-background">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link " href="login_page.jsp"><span class="	fa fa-address-book"></span>&nbsp Login</a>
      </li>
      <li class="nav-item">
        <a class="nav-link " href="Register.jsp"><span class="	fa fa-address-book fa fa-login"></span>&nbsp Signup</a>
      </li>
    </ul>
